...
import Clientes from '../pages/Listagens/clientes';
import Produtos from '../pages/Listagens/produtos';
import Servicos from '../pages/Listagens/servicos';
...
import ClienteServico from '../pages/Mesclar/Cliente-Servico'
import ClienteProduto from '../pages/Mesclar/Cliente-Produto'
...
import ConsumoGeneros from '../pages/Consumos/Consumo-Genero/index'
import ConsumoValor from '../pages/Consumos/Consumo-Valor/index'
import ConsumoMenor from '../pages/Consumos/Consumo-Menor/index'
import ConsumoPSConsumido from '../pages/Consumos/Consumo-Maior-PS/index'
import ConsumoConsumidor from '../pages/Consumos/Consumo-Maior-Qnt/index'
