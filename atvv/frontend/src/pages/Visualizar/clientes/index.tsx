    ...
    return (
        <section>
            ...
            <main>
                ...
                <Button variant="outline-dark" onClick={() => navigate(-1)}>Voltar</Button>{' '}
                <Card
                    bg="white"
                    text="dark"
                    style={{ width: '18rem' }}
                ...
                >
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            ...
                            <Button variant="success" onClick={() => navigate(`/editar_cpf/${cliente?.cliente_id}/${cliente?.cpf.cpf_id}`)}>Editar CPF</Button>{' '}
                        </Card.Text>
                        <Card.Text>
                                ...
                                return (
                                    <>
                                        <p>
                                            ...
                                            <Button variant="success" onClick={() => navigate(`/editar_rg/${cliente.cliente_id}/${rg.rg_id}`)}>Editar RG</Button>{' '}
                                            <Button variant="danger" onClick={() => deletar(rg.rg_id)}>Deletar RG</Button>{' '}
                                        </p>
                                    </>
                                )
                            })}
                            <Button variant="outline-dark" onClick={() => navigate(`/cadastrar_rg/${cliente?.cliente_id}`)}>Adicionar RG</Button>{' '}
                            ...
                            {cliente && cliente?.telefones?.map(tell => {
                                return (
                                    <>
                                        ...
                                        <Button variant="success" onClick={() => navigate(`/editar_tell/${cliente.cliente_id}/${tell?.telefone_id}`)}>Editar Tell.</Button>{' '}
                                        <Button variant="danger" onClick={() => deletarTell(tell?.telefone_id)}>Deletar Tell.</Button>{' '}
                                        <br></br>
                                    </>)
                            })}
                            <Button variant="outline-dark" onClick={() => navigate(`/cadastrar_telefone/${cliente?.cliente_id}`)}>Adicionar Tell.</Button>{' '}
                        </Card.Text>
                    </Card.Body>
                </Card>
            </main>
