                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div className="Button">
                                                <Button variant="success" onClick={() => navigate(`/editar_servico/${s.servico_id}`)}>Editar</Button>{' '}
                                                <Button variant="outline-dark" onClick={() => navigate(`/servicos/${s.servico_id}`)}>Visualizar</Button>{' '}
                                                <Button variant="danger" onClick={() => deletar(s.servico_id)}>Remover</Button>{' '}
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
