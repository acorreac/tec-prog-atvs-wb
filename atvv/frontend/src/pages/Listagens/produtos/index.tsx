                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div className="Button">
                                                <Button variant="success" onClick={() => navigate(`/editar_produto/${p.produto_id}`)} >Editar</Button>{' '}
                                                <Button variant="outline-dark" onClick={() => navigate(`/produtos/${p.produto_id}`)}>Visualizar</Button>{' '}
                                                <Button variant="danger" onClick={() => deletar(p.produto_id)}>Remover</Button>{' '}
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
