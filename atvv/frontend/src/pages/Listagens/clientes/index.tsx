                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div className='Button'>
                                                <Button variant="success" onClick={() => navigate(`/editar_cliente/${cliente.cliente_id}`)}>Editar</Button>{' '}
                                                <Button variant="outline-dark"  onClick={() => navigate(`/clientes/${cliente.cliente_id}`)}>Visualizar</Button>{' '}
                                                <Button variant="outline-dark" onClick={() => navigate(`/cadastrar_produto/${cliente.cliente_id}`)}>Adicionar Produtos</Button>{' '}
                                                <Button variant="outline-dark" onClick={() => navigate(`/cadastrar_produto_servico/${cliente.cliente_id}`)}>Adicionar Serviços</Button>{' '}
                                                <Button variant="danger" onClick={() => deleteUser(cliente.cliente_id)} >Remover</Button>{' '}
                                            </div>
                                        </td>
                                    </tr>
                                )
